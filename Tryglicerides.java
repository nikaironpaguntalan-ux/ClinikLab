...
public class Tryglicerides extends ChemistryTest{
    boolean fasting;
    public Tryglicerides(String name, String sex, int age){
    ...
    public void TestTaken() {
        ...
        System.out.println("Tryglicerides test taken");
        ...
        if (hoursSinceMeal >= 9) {
            fasting = true;
            System.out.println("You are allowed to take the Tryglicerides test.");
            System.out.print("Enter your Tryglicerides level in mg/dL: ");
            mgdl = input.nextDouble();
            System.out.println("Your Tryglicerides in SI units: " + SIconverter() + "mmol/L");
            if (sex.equalsIgnoreCase("male")) {
                if (mgdl <= 59 ) {
                    System.out.println("Result: Low Tryglicerides (High Heart Risk)");
                } else if (mgdl >= 60 && mgdl <=165) {
                    System.out.println("Result: Normal Tryglicerides");
                } else {
                    System.out.println("Result: High Tryglicerides");
                }
